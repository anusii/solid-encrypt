          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              padding: EdgeInsets.all(kDefaultPadding*1.5),
                child: ProfileInfo(profData:profData, profType:'private', webId: webId, 
                            authData: authData, encryptClient: encryptClient)
            ),
          )
        ],
      ),
        ...
        child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            if(snapshot.connectionState == ConnectionState.done){
              returnVal = _loadedScreen(snapshot.data, webId, logoutUrl, authData, widget.encryptClient);
            }
            else{
